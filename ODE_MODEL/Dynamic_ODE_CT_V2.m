...
%% -----------------------------------------------
function states_dot = Dynamic_ODE_CT_V2(states,controls,params)

e1 = states(1);e2 = states(2);e3 = states(3);
e4 = states(4);e5 = states(5);e6 = states(6);
z1 = states(7); z2 = states(8); z3 = states(9);
...
%% Output ---------------------------    
    ...
    fx = -Mm^(-1)*(Cm*X2 + Gv);
    dX1dt = X2;
    dX2dt = fx + gx*[u1;u2;u3];

    % states_dot = [dX1dt - dqr ;dX2dt - ddqr ;X1 - qr];
    states_dot = [dX1dt - dqr ;dX2dt - ddqr ;E1];
