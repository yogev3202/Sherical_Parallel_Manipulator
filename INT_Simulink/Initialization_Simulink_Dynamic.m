...
CTR_MASK = Simulink.Mask.get('Dynamic_Simulation_Final/SQP_CONTROLLER');
...
opt.qpsolver='ipopt_sparse';  %ipopt_sparse , qpoases , qpoases_sequence ipopt_sparse
...
% lb_x = -[1000;50;50;500;500;500]*(pi/180);
% ub_x =  [1000;50;50;500;500;500]*(pi/180);

lb_x = -[1000;70;70;650*ones(3,1)]*(pi/180);
ub_x =  [1000;70;70;650*ones(3,1)]*(pi/180);
...
lb_g = [ones(3,1)*0.01;0.02;-1000*(pi/180)*ones(3,1)];
ub_g = [ones(3,1)*2;1000;1000*(pi/180)*ones(3,1)];           
lb_gN = [ones(3,1)*0.01;0.02;-1000*(pi/180)*ones(3,1)];
ub_gN = [ones(3,1)*2;1000;1000*(pi/180)*ones(3,1)]; 
