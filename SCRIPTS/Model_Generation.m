...
settings.model='Dynamic_Model_V2';
% settings.model='Err_Kinematic_Model';
% settings.model='Err_Dynamic_Model';
% settings.model='Err_Dynamic_Model_V2';
% settings.model = 'Dynamic_Model_QPLV';
% settings.model='Kinematic_Model_V2';
run(settings.model);
...
% P = CodeGenerator ('Chek_Cons.c', opts) ;
% P.add(Ci_fun);
% P.generate();
% 
% mex Chek_Cons.c
