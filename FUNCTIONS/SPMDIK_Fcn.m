...
%   theta ref angle (r2)
%   phi ref angle (r3)
%   psi ref angle rate (dr1)
%   theta ref angle rate (dr2)
%   phi ref angle rate (dr2)


% Output: 
%   revolute joint1 vel (u1)
%   revolute joint2 vel (u2)
%   revolute joint3 vel (u3)


function dq = SPMDIK_Fcn(r,dr)
