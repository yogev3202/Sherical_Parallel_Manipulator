...
%% LEG 1: PROXIMAL (Kg,mm)
    ...
    Prox1 = struct;
    Prox1.m = Delta*8.38027712158635e-003;  


    % Center of mass vector: Taken at the body frame coordinate system.
    Prox1.R_Bf = Delta*[0;15.00104516;-30.52515296];
    ...
    Prox1.I_Bf = Delta*[Prox1_Ixx_Bf , Prox1_Ixy_Bf , Prox1_Ixz_Bf;
...
%% LEG 1: DISTAL (Kg,mm)
    ...
    Dist1 = struct;
    Dist1.m = Delta*6.71322338197224e-003;  

    
    % Center of mass vector: Taken at the body frame coordinate system.
    Dist1.R_Bf = Delta*[10.98040456;19.39131205;0.00000884];
    ...
    Dist1.I_Bf = Delta*[Dist1_Ixx_Bf , Dist1_Ixy_Bf , Dist1_Ixz_Bf;
...
%% LEG 2: PROXIMAL (Kg,mm)
    ...
    Prox2 = struct;
    Prox2.m = Delta*9.02521759129636e-003;  

    
    % Center of mass vector: Taken at the body frame coordinate system.
    Prox2.R_Bf = Delta*[0;13.67861771;-28.93291259];
    ...
    Prox2.I_Bf = Delta*[Prox2_Ixx_Bf , Prox2_Ixy_Bf , Prox2_Ixz_Bf;
...
%% LEG 2: DISTAL (Kg,mm)   
    ...
    Dist2 = struct;
    Dist2.m = Delta*6.71327365781553e-003;  

    
    % Center of mass vector: Taken at the body frame coordinate system.
    Dist2.R_Bf = Delta*[10.98040499;19.39131230;0.00000884];
    ...
    Dist2.I_Bf = Delta*[Dist2_Ixx_Bf , Dist2_Ixy_Bf , Dist2_Ixz_Bf;
...
%% LEG 3: PROXIMAL (Kg,mm)
    ...
    Prox3 = struct;
    Prox3.m = Delta*9.35728764600804e-003;  

    
    % Center of mass vector: Taken at the body frame coordinate system.
    Prox3.R_Bf = Delta*[0;12.86419686;-26.50463644];
    ...
    Prox3.I_Bf = Delta*[Prox3_Ixx_Bf , Prox3_Ixy_Bf , Prox3_Ixz_Bf;
...
%% LEG 3: DISTAL (Kg,mm)      
    ...
    Dist3 = struct;
    Dist3.m = Delta*6.71323366453039e-003; 

    
    % Center of mass vector: Taken at the body frame coordinate system.
    Dist3.R_Bf = Delta*[10.98040449;19.39131205;0.00000862];
    ...
    Dist3.I_Bf = Delta*[Dist3_Ixx_Bf , Dist3_Ixy_Bf , Dist3_Ixz_Bf;
...
%% PLATFORM -----------------------------------------------------
    ...
    Platform = struct;
    Platform.m = Delta*4.38998768456049e-002; 


    
    % Center of mass vector: Taken at the body frame coordinate system.
    Platform.R_Bf = Delta*[0.00002029;-0.00003363;-8.06965072];
    ...
    Platform.I_Bf = Delta*[Platform_Ixx_Bf , Platform_Ixy_Bf , Platform_Ixz_Bf;
