...
rho1 = params(1);rho2 = params(2);rho3 = params(3);
rho4 = params(4);rho5 = params(5);rho6 = params(6);
Rho = [rho1;rho2;rho3;rho4;rho5;rho6];

p1 = params(7);p2 = params(8);p3 = params(9);
p4 = params(10);p5 = params(11);p6 = params(12);
p7 = params(13);p8 = params(14);p9 = params(15);
...
% explicit ODE RHS
RHS = Qlpv_Dynamic_ODE_CT(states,controls,Rho);
x_dot = [RHS;RHS- [dqr;ddqr]];
...
[h_expr,hN_expr] = h_expr_Fcn_QLPV(states,controls,params);
general_con = h_expr;
