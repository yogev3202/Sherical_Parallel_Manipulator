...
const NeZCData *DynamicValidation_dfaed711_1_ZCData = NULL;
PmfMessageId DynamicValidation_dfaed711_1_computeAsmModeVector(const double
...
PmfMessageId DynamicValidation_dfaed711_1_computeSimModeVector(const double
  *input, const double *inputDot, const double *inputDdot, int *modeVector,
  double *errorResult, NeuDiagnosticManager *neDiagMgr)
{
  (void) input;
...
PmfMessageId DynamicValidation_dfaed711_1_computeZeroCrossings(const
