function Flag = Collisions_V2(x,OP_Dis)
...
for c1 = 1:1:4    
   ...
   for c2 = 4+1:1:8
      ...
      Optimal_sol = OP_Dis('x0', Int,'lbx' , lbx , 'ubx' , ubx ,'p',PARAMS); 
      A1_sol = full(Optimal_sol.x(1));
      A2_sol = full(Optimal_sol.x(2));
      Seg1 = A1_sol*Xa1 + (1-A1_sol)*Xb1;
      Seg2 = A2_sol*Xa2 + (1-A2_sol)*Xb2;
      Distance = norm(Seg1-Seg2);
      if (Distance<=Epsilon_max && Distance>=Epsilon_min)
          Flag = true;
          break;
      end
