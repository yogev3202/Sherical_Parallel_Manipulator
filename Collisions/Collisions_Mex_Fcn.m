function Flag = Collisions_Mex_Fcn(x,Diameter)
...
OF = 27.19 * 1e-3;
% Diameter = Raios;
% Delta = (0.5*Raios + 2) * 1e-3;
% Delta = (0.5*Raios) * 1e-3;
...
Epsilon_max = 2 * ((0.5*Diameter) * 1e-3);
...
for i = 1:1:4
   for j = 1:1:4
      for k = 1:1:4
          ...
          Optimal_sol = Collition_Detector(Int,[0;0],PARAMS12);
          A1_sol12 = Optimal_sol(1);
          A2_sol12 = Optimal_sol(2);         
          ...
          Optimal_sol = Collition_Detector(Int,[0;0],PARAMS13);
          A1_sol13 = Optimal_sol(1);
          A2_sol13 = Optimal_sol(2);
          ...
          Optimal_sol = Collition_Detector(Int,[0;0],PARAMS23);
          A1_sol23 = Optimal_sol(1);
          A2_sol23 = Optimal_sol(2);
