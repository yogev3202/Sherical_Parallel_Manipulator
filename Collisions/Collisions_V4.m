function Flag = Collisions_V4(x,OP_Dis)
...
%     [u_opt,fval,exitflag,~,~] = qpOASES(Hessian,F',A,...
%         lb,ub,lbA,ubA,options);

for Leg1 = 1:1:4
   for Leg2 = 1:1:4
      for Leg3 = 1:1:4
          Seg_Leg1 = Segments_Leg1{Leg1};
          Seg_Leg2 = Segments_Leg2{Leg2};
          Seg_Leg3 = Segments_Leg1{Leg3};
          ...
          Seg2 = A2_sol12*S2xb + (1-A2_sol12)*S2xb;
          ...
          Seg2 = A2_sol13*S3xb + (1-A2_sol13)*S3xb;
          ...
          Seg2 = A2_sol23*S3xb + (1-A2_sol23)*S3xb;
